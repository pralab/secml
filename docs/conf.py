...
project = u'AdversariaLib2'
copyright = u'2015, PRALab'
...
# html_theme = 'default'
html_theme = "sphinx_rtd_theme"  # ReadTheDocs
...
def skip(app, what, name, obj, skip, options):
    if (what is 'class' or what is 'module') and ('test' in name or 'Test' in name):
