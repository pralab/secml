...
class TestCClassifierRandomForest(CUnitTest):
    ...
    def test_fun(self):
        ...
        df_scores_0 = self.rnd_forest.discriminant_function(x, y=0)
        self.logger.info(
            "discriminant_function(x, y=0):\n{:}".format(df_scores_0))
        _check_df_scores(df_scores_0, self.dataset.num_samples)

        df_scores_1 = self.rnd_forest.discriminant_function(x, y=1)
        self.logger.info(
            "discriminant_function(x, y=1):\n{:}".format(df_scores_1))
        _check_df_scores(df_scores_1, self.dataset.num_samples)

        df_scores_2 = self.rnd_forest.discriminant_function(x, y=2)
        self.logger.info(
        ...
        ds_priv_scores_0 = self.rnd_forest._discriminant_function(x_norm, y=0)
        ...
        ds_priv_scores_1 = self.rnd_forest._discriminant_function(x_norm, y=1)
        ...
        ds_priv_scores_2 = self.rnd_forest._discriminant_function(x_norm, y=2)
        ...
        df_scores_0 = self.rnd_forest.discriminant_function(p, y=0)
        self.logger.info(
            "discriminant_function(p, y=0):\n{:}".format(df_scores_0))
        _check_df_scores(df_scores_0, 1)

        df_scores_1 = self.rnd_forest.discriminant_function(p, y=1)
        self.logger.info(
            "discriminant_function(p, y=1):\n{:}".format(df_scores_1))
        _check_df_scores(df_scores_1, 1)

        df_scores_2 = self.rnd_forest.discriminant_function(p, y=2)
        self.logger.info(
