...
class TestCClassifierDecisionTree(CClassifierTestCases):
    ...
    def test_classify(self):
        ...
        self.logger.info("Number of classes: {:}".format(self.dec_tree.n_classes))
    ...
    def test_preprocess(self):
        ...
        self._test_preprocess(
            self.dataset, self.dec_tree, ["pca", "unit-norm"], [{}, {}]
        )
    ...
    def test_plot(self):
        ...
        fig.savefig(
            fm.join(fm.abspath(__file__), "figs", "test_c_classifier_decision_tree.pdf")
        )
