...
class TestCClassifierSkLearn(CClassifierTestCases):
    ...
    def setUp(self):
        ...
        self.skclfs = [
            ...
            SVC(
                kernel="linear", C=0.025, random_state=0, decision_function_shape="ovr"
            ),
    ...
    def test_fun(self):
        ...
        for i, clf in enumerate(self.classifiers):
            ...
            try:
                ...
                self.logger.info("This sklearn model does not support sparse data!")
    ...
    def test_pretrained(self):
        ...
        self.logger.info("Predicted labels by pretrained model:\n{:}".format(y_pred))
        self.logger.info("Predicted labels by our fit:\n{:}".format(y_pred_secml))
