...
class TestCDatasetHeader(CUnitTest):
    ...
    def test_getitem(self):
        ...
        self.assert_array_equal(params["colors"], CArray([1, 3]))
    ...
    def test_append(self):
        ...
        self.assertEqual(params["age"], 34)
        self.assertEqual(params["days"], ("Mon", "Tue", "Wed", "Thu"))
        self.assert_array_equal(params["colors"], CArray([1, 2, 3, 1, 2, 3]))

        # Create an additional header with new attributes set
        h2 = CDatasetHeader(a=4, age=34, colors=CArray([10, 20, 30]))
        ...
        self.assert_array_equal(params["colors"], CArray([1, 2, 3, 10, 20, 30]))
