...
class TestCExplainerLocalIntegratedGradients(CUnitTest):
    """Unittests for CExplainerLocalIntegratedGradients"""
    ...
    def setUp(self):
        ...
        self.explainer = CExplainerLocalIntegratedGradients(self.clf, self.ds)
    ...
    def test_explain(self):
        ...
        attr = self.explainer.explain(
            x, reference=ref_img, m=m, classes=self.ds.classes)
