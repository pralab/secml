...
class TestCClassifierKNN(CUnitTest):
    ...
    def test_fun(self):
        ...
        ds_priv_scores_0 = self.knn._discriminant_function(x_norm, label=0)
        ...
        ds_priv_scores_1 = self.knn._discriminant_function(x_norm, label=1)
        ...
        ds_priv_scores_2 = self.knn._discriminant_function(x_norm, label=2)
