...
class TestCClassifierKNN(CUnitTest):
    ...
    def test_fun(self):
        ...
        labels, scores = self.knn.classify(self.dataset.X)
        ...
        labels, scores = self.knn.classify(self.dataset.X[0, :].ravel())
