...
class TestConstraintL1(CConstraintTestCases.TestCConstraint):
    """Test the L1 distance constraint."""

    def _constr_creation(self):
        center = 0
        radius = 1
        self._constr = CConstraintL1(center=center, radius=radius)

    def _set_constr_name(self):
        self._constr_name = 'L1'
