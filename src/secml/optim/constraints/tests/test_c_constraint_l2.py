...
class TestCConstraintL2(CConstraintTestCases):
    ...
    def test_is_active(self):
        ...
        self._test_is_active(self.c_array, self.p1_inside, self.p2_outside, self.p3_on)
    ...
    def test_constraint(self):
        ...
        self._test_constraint(self.c_array, self.p1_inside, self.p2_outside, self.p3_on)
    ...
    def test_gradient(self):
        ...
        self.assert_array_almost_equal(self.c.gradient(self.p1_inside), CArray([0, 0]))
