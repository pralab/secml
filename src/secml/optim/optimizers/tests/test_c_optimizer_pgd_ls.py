...
class TestCOptimizerPGDLS(COptimizerTestCases):
    ...
    def test_minimize_3h_camel(self):
        ...
        self._test_minimize(COptimizerPGDLS, "3h-camel", opt_params=opt_params)

    def test_minimize_beale(self):
        """Test for COptimizer.minimize() method on beale fun."""
        opt_params = {"eta": 1e-6, "eta_min": 1e-4, "eps": 1e-12}

        self._test_minimize(COptimizerPGDLS, "beale", opt_params=opt_params)
    ...
    def test_minimize_mc_cormick(self):
        ...
        self._test_minimize(COptimizerPGDLS, "mc-cormick", opt_params=opt_params)
    ...
    def test_minimize_rosenbrock(self):
        ...
        self._test_minimize(COptimizerPGDLS, "rosenbrock", opt_params=opt_params)

    def test_constr_bounds(self):
        """Test for COptimizer.minimize() method behaviour
        depending on constraint and bounds."""
        self._test_constr_bounds(COptimizerPGDLS)
